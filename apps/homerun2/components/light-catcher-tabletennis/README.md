...
| `HOMERUN2_LIGHT_CATCHER_KUSTOMIZE_VERSION` | `v1.1.4` | OCI kustomize artifact version, shared with `light-catcher` |
| `HOMERUN2_LIGHT_CATCHER_VERSION` | `v1.1.4` | Container image tag, shared with `light-catcher` |
