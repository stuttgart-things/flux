...
| `HOMERUN2_LIGHT_CATCHER_KUSTOMIZE_VERSION` | `v1.1.0` | OCI kustomize artifact version (not `v1.0.1`: an orphaned March artifact) |
| `HOMERUN2_LIGHT_CATCHER_VERSION` | `v1.1.0` | Container image tag |
