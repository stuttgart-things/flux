...
|---|---|---|
| [crossplane](crossplane/) | Crossplane and one **profile**'s Configuration set — `cicd-platform` (default) or `machinery`, selected with `CROSSPLANE_PROFILE` | Kustomize components composed by per-profile build roots |
