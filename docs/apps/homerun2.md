...
| Variable | Default | Description |
|---|---|---|
| `HOMERUN2_OMNI_PITCHER_VERSION` | see `requirements.yaml` | OCI kustomize base + container image tag |
...
| Variable | Default | Description |
|---|---|---|
| `HOMERUN2_CORE_CATCHER_VERSION` | see `release.yaml` | Container image tag |
| `HOMERUN2_CORE_CATCHER_KUSTOMIZE_VERSION` | see `requirements.yaml` | OCI kustomize base tag (use `-web` suffix for web mode) |
