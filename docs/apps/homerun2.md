...
| Variable | Default | Description |
|---|---|---|
| `HOMERUN2_OMNI_PITCHER_VERSION` | `v2.1.1` | OCI kustomize base + container image tag |
...
| Variable | Default | Description |
|---|---|---|
| `HOMERUN2_CORE_CATCHER_VERSION` | `v1.0.1` | Container image tag |
| `HOMERUN2_CORE_CATCHER_KUSTOMIZE_VERSION` | `v1.0.1` | OCI kustomize base tag (use `-web` suffix for web mode) |
