...
| Variable | Default | Description |
|---|---|---|
| `HOMERUN2_CORE_CATCHER_VERSION` | `v1.0.2` | Container image tag |
| `HOMERUN2_CORE_CATCHER_KUSTOMIZE_VERSION` | `v1.0.2` | OCI kustomize base tag (use `-web` suffix for web mode) |
